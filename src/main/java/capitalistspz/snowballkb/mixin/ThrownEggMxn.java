...
public abstract class ThrownEggMxn extends ThrowableItemProjectile {
    public ThrownEggMxn(EntityType<? extends @NotNull ThrowableItemProjectile> entityType, Level world) {
    ...
    protected void onHitPlayer(Entity entity, DamageSource source, float damage, Operation<Void> original) {
        SnowballKB.OnHit(SnowballKB.GetThrownItemConfig(SnowballKB.ThrownItem.Egg), this, entity, source, damage, original);
    }
}
