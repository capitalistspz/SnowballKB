...
public abstract class ThrownEnderpearlMxn extends ThrowableItemProjectile {
    public ThrownEnderpearlMxn(EntityType<? extends @NotNull ThrowableItemProjectile> entityType, Level world) {
    ...
    protected void onHitPlayer(Entity entity, DamageSource source, float damage, Operation<Void> original) {
        SnowballKB.OnHit(SnowballKB.GetThrownItemConfig(SnowballKB.ThrownItem.Enderpearl), this, entity, source, damage, original);
    }
}
