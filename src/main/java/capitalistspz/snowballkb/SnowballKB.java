...
public class SnowballKB implements ModInitializer {
    ...
    public static final TagKey<@NotNull EntityType<?>> AFFECTED_TAG_KEY = TagKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath("snowballkb", "affected"));
    public static HolderSet<@NotNull EntityType<?>> affectedEntities;
    ...
    public static boolean appliesToEntity(Entity entity) {
        if (entity instanceof LivingEntity livingEntity) {
            ...
            if (affectedEntities == null)
                return false;
            var typeHolder = entity.typeHolder();
            return affectedEntities.contains(typeHolder);
        }
        return false;
    }
